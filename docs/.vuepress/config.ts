...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  locales: {
    '/': {
      ...
      description: 'violets007的个人技术和生活分享博客',
    }
  },
  ...
  themeConfig: {
    ...
    repo: 'violets007/violets007', // 导航栏右侧生成Github链接
    ...
    author: {
      name: 'violets007', // 必需
      link: 'https://github.com/violets007', // 可选的
    },

    // 博主信息 (显示在首页侧边栏)
    blogger: {
      avatar: '/img/20490066.jpeg',
      name: 'violets007',
      slogan: '后端届的小学生',
    },
    ...
    footer: {
      ...
      copyrightInfo:
        'violets007 | <a href="https://github.com/xugaoyi/vuepress-theme-vdoing/blob/master/LICENSE" target="_blank">MIT License</a>', // 博客版权信息、备案信息等，支持a标签或换行标签</br>
    },
